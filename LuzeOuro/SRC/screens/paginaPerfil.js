  ...
  return (
    <View style={[styles.container, { backgroundColor: colors.background }]}>
      ...
      <ScrollView contentContainerStyle={styles.scrollContent}>
        ...
        {/* Botão de alternar tema (agora aqui embaixo) */}
        <TouchableOpacity
        ...
        <View
          style={[styles.navSection, { backgroundColor: colors.card, borderColor }]}
        >
          <TouchableOpacity
      ...
      <View
        style={[
          styles.bottomNav,
          { backgroundColor: colors.background, borderTopColor: dividerColor },
        ]}
      >
...
const styles = StyleSheet.create({
  ...
  logoImage: { width: 35, height: 35, borderRadius: 5, marginRight: 10 },
  ...
  quickAccessText: { marginLeft: 10, fontSize: 14, fontWeight: "600" },
  navSection: {
    marginHorizontal: 15,
    borderRadius: 12,
    borderWidth: 1,
